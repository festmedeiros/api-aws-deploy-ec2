 ...
 * /health:
 *   get:
 *     summary: Status e versão da API
 *     tags: [Health]
 *     responses:
 *       200:
 *         description: OK
...
app.post('/init-db', async (req, res) => {
    try {
      ...
      logInfo('Sucesso SQL', req);
    } catch (err) {
      logError("Erro ao testar SQL", req, error);
...
app.get('/mongodb/testar-conexao', async (req, res) => {
    try {
        ...
        await logInfo('Erro ao conectar no MongoDb' + error, req, error);
...
app.post('/usuarios', async (req, res) => {
    try {
        ...
        logInfo("Erro ao criar usuário", req, error);
...
app.get('/usuarios', async (req, res) => {
    try {
        ...
        logInfo("Erro ao buscar usuários", req, error);
        res.status(500).send('Ocorreu um erro interno');
    }
...
app.get('/usuarios/:id', async (req, res) => {
    try {
        ...
        logInfo("Erro ao buscar usuário", req, error);
        res.status(500).send('Ocorreu um erro interno');
    }
...
app.put('/usuarios/:id', async (req, res) => {
    try {
        ...
        logInfo("Erro ao atualizar usuário", req, error);
        res.status(500).send('Ocorreu um erro interno');
    }
});
...
app.delete('/usuarios/:id', async (req, res) => {
    try {
        ...
        logInfo("Erro ao remover usuário", req, error)
        res.status(500).send('Ocorreu um erro interno');
    }
